  ...
  const handleSubmitImport = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL.WAREHOUSE.IMPORT.CREATE}`,
        {
          receiptCode: code,
          receiptName: name,
          wareId: wareId,
  ...
  return (
    <>
      <div className="d-flex flex-column gap-7">
        <div className="px-9">
          <Link to="/apps/stockIn" className="fs-5 fw-bold text-gray-500 text-hover-dark d-flex align-items-center">
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-end gap-2">
                ...
                <button type="button" className="btn btn-primary" onClick={handleSubmitImport} disabled={loading}>
                  {loading ? (
