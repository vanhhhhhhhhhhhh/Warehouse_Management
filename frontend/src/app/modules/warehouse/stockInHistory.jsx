...
const StockInHistory = () => {
  ...
  const uniqueWarehouses = Array.from(new Set(stockImports.map((stock) => stock.wareId?.name).filter(Boolean)));
          ...
          <div className="card-header border-0">
            <div className="d-flex align-items-center position-relative gap-5 flex-wrap">
              ...
              <div className="card-toolbar">
                <button type="button" className="btn btn-light-primary me-3" onClick={handleResetFilters}>
              ...
              <div className="col-md-3 col-xxl-3">
                <div className="card h-md-100">
                  <div className="card-body d-flex flex-column flex-center">
                    ...
                    <div className="fs-2hx fw-bold text-gray-800 mb-2 lh-1 ls-n1">
                      {filteredImports
                        .reduce((total, imp) => total + calculateTotalValue(imp.items), 0)
                        .toLocaleString()}
                      đ
                    </div>
                          ...
                          <td>
                            <div className="d-flex flex-column">
                              ...
                              {imports.items?.length > 2 && (
                                <div className="text-muted">+{imports.items.length - 2} sản phẩm khác</div>
                              )}
                            </div>
                          </td>
                          <td>
                            <span className="badge badge-light-success">{countTotalProduct(imports.items)}</span>
                          </td>
                          <td>
